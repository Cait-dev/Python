...
Button(frame, text='Calcular', command=calcular, bg="#2980b9", fg='white').grid(column=2, row=2)
Button(frame, text='Salir', command=root.quit, bg="#2980b9", fg='white').grid(column=3, row=2)
